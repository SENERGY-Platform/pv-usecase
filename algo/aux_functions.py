...
def preprocess_weather_data(new_weather_data):
    ...
    aux_list = [[pd.to_datetime(data_point['time']).tz_localize(None).hour, data_point['instant_air_temperature'], data_point['instant_relative_humidity'],
